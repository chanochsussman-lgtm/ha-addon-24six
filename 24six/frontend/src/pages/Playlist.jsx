...
export default function Playlist() {
  ...
  useEffect(() => {
    api.playlist(id).then(d => setMeta(d?.playlist || d?.data || d));
    api.playlistSongs(id).then(d => setSongs(normalize(d)));
  }, [id]);
    ...
    <div className="p-6">
      <div className="flex gap-6 mb-8">
        ...
        <div className="flex flex-col justify-end">
          <p className="text-text-secondary text-xs uppercase tracking-wider mb-1">Playlist</p>
